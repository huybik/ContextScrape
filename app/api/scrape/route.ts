...
# GOAL
Your primary goal is to transform a collection of scraped web pages single high quality api document. The output should be stripped of all other irrelevant information. Also remove all text that is in different language from dominant languages.
